        ...
        <Dialog.Content className={[dialogStyles.content, styles.content].join(' ')} aria-describedby={undefined}>
          ...
          <section className={styles.section}>
            ...
            <ol className={styles.list}>
              ...
              <li><strong>离开前退出：</strong>点右上角退出登录；下次进入时再用主密码解锁。</li>
            </ol>
          </section>
          ...
          <details className={styles.details}>
            ...
            <ul className={styles.list}>
              ...
              <li>退出登录会清除当前页面的解密能力，并遮罩刚才显示的内容。</li>
            </ul>
          </details>
          ...
          <details className={styles.details}>
            ...
            <ul className={styles.list}>
              ...
              <li>企业恢复是可选能力，不影响先创建和使用。公司可设置 2 至 6 位恢复管理员，每次由其中任意两位分别确认，任何一人都不能单独恢复。</li>
            </ul>
          </details>
